...
- `.agent/context-capsules/cross-repo-findings-capsule.public.json` - отдельный обезличенный capsule с актуальными изысканиями по контейнерному и тестовому workspace для быстрого старта следующего агента.
